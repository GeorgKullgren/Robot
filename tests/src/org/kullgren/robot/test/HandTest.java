...
public class HandTest extends AndroidTestCase {
    ...
    @Test
    public void testMoveFirstCardRight() {
        hand.addCard(card0);
        hand.addCard(card1);
        hand.addCard(card2);
        ...
        hand.moveSelectedCardsRight();
        assertTrue(hand.getCard(1).equals(card0));
    }

    @Test
    public void testMoveLastCardRightDontReorderHand() {
        hand.addCard(card0);
        hand.addCard(card1);
        hand.addCard(card2);
        ...
        hand.moveSelectedCardsRight();
        assertTrue(hand.getCard(2).equals(card2));
    }
